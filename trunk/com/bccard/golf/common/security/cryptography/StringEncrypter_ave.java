 ...
 * @author csj007
 */
public class StringEncrypter_ave {
	 ...
	 * @throws Exception
	 */
	public StringEncrypter_ave(String key, String initialVector) throws Exception {
	 ...
	 * @throws Exception
	 */
	public StringEncrypter_ave(String value) throws Exception {
	  if (value == null || value.equals(""))
	   throw new Exception("The cipher string can not be null or an empty string.");
		...
		// Initialize an encryption key and an initial vector.
		//MessageDigest md5 = MessageDigest.getInstance("MD5");  
		this.key = new SecretKeySpec(skey.getEncoded(), "AES");
		this.initalVector = new IvParameterSpec(value.getBytes("UTF8"));
