 ...
 * @version	1.0
 ******************************************************************************/
public class GolfLsnRecvInqDaoProc extends AbstractProc {
	
	/** *****************************************************************
	 * GolfLsnRecvInqDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfLsnRecvInqDaoProc() {}	
		...
		try {
			...
			if(rs != null) {
				while(rs.next())  {
					...
					result.addString("MEMO_EXPL"		,GolfUtil.getUrl(rs.getString("MEMO_EXPL")) );
    ...
    ************************************************************************ */
    private String getSelectQuery(){
		...
		sql.append("\n TGR.APLC_SEQ_NO, TGR.CDHD_ID, DECODE(TGR.SEX_CLSS, 'M', '남', 'F', '여') SEX_CLSS, TGR.EMAIL, TGR.DDD_NO||'-'||TGR.TEL_HNO||'-'||TGR.TEL_SNO TEL, 	");
