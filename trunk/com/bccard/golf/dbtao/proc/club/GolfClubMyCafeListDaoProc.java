 ...
 * @version	1.0
 ******************************************************************************/
public class GolfClubMyCafeListDaoProc extends AbstractProc {
	
	/** *****************************************************************
	 * GolfClubMenuListDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfClubMyCafeListDaoProc() {}	
    ...
    ************************************************************************ */
    private String getSelectQuery(){
		...
		sql.append("\n SELECT");
		sql.append("\n 		TC.CLUB_SEQ_NO, '[시샵]'||TC.CLUB_NM CLUB_NM  	");
		sql.append("\n FROM");
		sql.append("\n BCDBA.TBGCLUBMGMT TC	");
		sql.append("\n WHERE TC.OPN_PE_ID = ?	");
		sql.append("\n AND TC.CLUB_OPN_AUTH_YN = 'Y'	");
		sql.append("\n AND TC.CLUB_ACT_YN = 'Y'	");
		
		sql.append("\n UNION ALL");
		
		sql.append("\n SELECT");
		sql.append("\n 		TC.CLUB_SEQ_NO, TC.CLUB_NM  	");
		sql.append("\n FROM");
		sql.append("\n BCDBA.TBGCLUBCDHDMGMT TCM, BCDBA.TBGCLUBMGMT TC	");
		sql.append("\n WHERE TCM.CLUB_SEQ_NO = TC.CLUB_SEQ_NO	");
		//sql.append("\n AND TCM.CLUB_SEQ_NO = ?	");
		sql.append("\n AND TCM.CDHD_ID = ?	");
		sql.append("\n AND TC.CLUB_OPN_AUTH_YN = 'Y'	");
		sql.append("\n AND TC.CLUB_ACT_YN = 'Y'	");
		//sql.append("\n ORDER BY TC.CLUB_NM ASC	");
