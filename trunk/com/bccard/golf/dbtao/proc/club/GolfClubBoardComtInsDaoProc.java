...
* @version	1.0
******************************************************************************/
public class GolfClubBoardComtInsDaoProc extends AbstractProc {
	 ...
	 * @param N/A
	 ***************************************************************** */
	public GolfClubBoardComtInsDaoProc() {}
	...
	public int execute(WaContext context, TaoDataSet data) throws DbTaoException  {
		...
		try {
			...
			pstmt.setString(++idx, data.getString("REPY_CTNT") ); 
    ...
    ************************************************************************ */
    private String getInsertQuery(){
		...
		sql.append("\n");
		sql.append("INSERT INTO BCDBA.TBGCLUBBBRDREPY (	\n");
		sql.append("\t  REPY_SEQ_NO, BBRD_SEQ_NO, REPY_CTNT, REG_ATON, REG_PE_ID, CHNG_ATON	\n");
		sql.append("\t ) VALUES (	\n");
    ...
    ************************************************************************ */
    private String getNextValQuery(){
        StringBuffer sql = new StringBuffer();
        sql.append("SELECT NVL(MAX(REPY_SEQ_NO),0)+1 REPY_SEQ_NO FROM BCDBA.TBGCLUBBBRDREPY \n");
		return sql.toString();
    }
}
