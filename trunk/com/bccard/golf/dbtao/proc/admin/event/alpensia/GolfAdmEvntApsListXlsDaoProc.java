...
*   클래스명  : GolfAdmEvntApsListXlsDaoProc
*   작성자    : (주)미디어포스 임은혜
*   내용      : 관리자 > 이벤트 > 알펜시아 > 엑셀 리스트
*   적용범위  : golf
*   작성일자  : 2010-06-24
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항
 ...
 * @version	1.0 
 ******************************************************************************/
public class GolfAdmEvntApsListXlsDaoProc extends AbstractProc {
	
	/** *****************************************************************
	 * GolfAdmOrdListDaoProc 프로세스 생성자   
	 * @param N/A
	 ***************************************************************** */
	public GolfAdmEvntApsListXlsDaoProc() {}	
    ...
    ************************************************************************ */
    private String getSelectQuery(TaoDataSet data) throws TaoException{
		...
		sql.append("\t	JOIN (SELECT ROWNUM RNUM, RSV.* FROM BCDBA.TBGGOLFEVNTAPLC RSV ORDER BY APLC_ATON) EVT ON COMPN.APLC_SEQ_NO=EVT.APLC_SEQ_NO	\n");
