...
* @version 1.0
******************************************************************************/
public class GolfAdmBerClubMutiUpdDaoProc extends AbstractProc {
  ...
  * @param N/A
  ***************************************************************** */
 public GolfAdmBerClubMutiUpdDaoProc() {}
   ...
   conn.setAutoCommit(false);
     ...
     for (int i = 0; i < seq_no.length; i++) {    
      if (seq_no[i] != null && seq_no[i].length() > 0) {
       ...
       pstmt.setString(++idx, data.getString("PRIZE_YN")); //강퇴여부 수정시
