...
* @version	1.0
******************************************************************************/
public class GolfAdmBoardComtDelDaoProc extends AbstractProc {

	public static final String TITLE = "관리자 공통게시판 덧글 삭제 처리";

	/** *****************************************************************
	 * GolfAdmBoardReDelDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfAdmBoardComtDelDaoProc() {}
