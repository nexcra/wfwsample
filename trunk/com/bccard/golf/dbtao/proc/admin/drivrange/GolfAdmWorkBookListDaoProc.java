...
*   클래스명  : GolfAdmWorkBookListDaoProc
*   작성자    : (주)만세커뮤니케이션 김태완
*   내용      : 관리자 연습장 리스트
*   적용범위  : golf
*   작성일자  : 2009-05-15
 ...
 * @version	1.0
 ******************************************************************************/
public class GolfAdmWorkBookListDaoProc extends AbstractProc {
	
	/** *****************************************************************
	 * GolfAdmWorkBookListDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfAdmWorkBookListDaoProc() {}	
	...
	public DbTaoResult execute(WaContext context,  HttpServletRequest request ,TaoDataSet data) throws BaseException {
		...
		try {
			...
			String sql = this.getSelectQuery(area_nm,exec_type_cd,search_sel,search_word);   
    ...
    * Query를 생성하여 리턴한다.    
    ************************************************************************ */
    private String getSelectQuery(String area_nm, String exec_type_cd, String search_sel, String search_word){
