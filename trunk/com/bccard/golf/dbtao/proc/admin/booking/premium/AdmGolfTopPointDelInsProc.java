 ...
 * @version 2010.12.30
 **************************************************************************** */
public class AdmGolfTopPointDelInsProc extends AbstractProc  {
		public static final String TITLE = "포인트관리 삭제";
		...
		************************************************************************ */
		public DbTaoResult  execute(WaContext context, TaoDataSet dataSet) throws BaseException {
				...
				Connection con = null;
				debug("***********************************************************************************");
				debug(" Lproc  AdmGolfTopPointDelInsProc  삭제 액션 execute");
				debug("***********************************************************************************");
		...
		************************************************************************ */
		...
		debug("***********************************************************************************");
		debug(" SQL  AdmGolfTopPointDelInsProc  삭제 액션 execute");
		debug(sql.toString());
		debug("***********************************************************************************");
