 ...
 * @version 2010.12.08
 **************************************************************************** */
public class GolfadmTopMemInqProc extends AbstractProc  {
   ...
   // public TaoResult execute(Connection con, TaoDataSet dataSet) throws TaoException {
        ...
        debug("========================================================================");
        debug("========================================================================");
				String sMESSAGE_KEY = "CommonProc_0000";
            ...
            MsgEtt msgEtt = new MsgEtt(MsgEtt.TYPE_ERROR, TITLE, sMESSAGE_KEY, null );
