...
public class GolfEvntShopViewActn extends GolfActn{
	...
	public static final String TITLE = "쇼핑 > 상세보기";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try { 
			...
			// 04-2. 옵션 = 옵션상품 중 '없음'만 있는 경우 '선택사항없음'으로 바꿔서 표기하기
			...
			if (goodsOptListResult !=null && goodsOptListResult.isNext() && goodsOptListResult.size() > 0) {
				...
				if (goodsOptListResult.size() == 1 && goodsOptListResult.getObject("SGL_LST_ITM_DTL_CTNT").equals("없음")) {	goodsOptDisy = "0";	}
			}
