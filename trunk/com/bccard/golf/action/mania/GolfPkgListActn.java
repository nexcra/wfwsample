...
* @version	1.0
******************************************************************************/
public class GolfPkgListActn extends GolfActn{
...
//			 01.세션정보체크
			...
			DbTaoResult coopCpSel = coopCpSelProc.execute(context, dataSet, "0022", "Y"); //제휴업체
			
			
			//04-1 권한조회
			// 04. 접근권한 조회	
			String permissionColum = "PKG_APO_YN";
			...
			paramMap.put("memb_yn", permission);
