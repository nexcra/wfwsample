...
* @version	1.0 
******************************************************************************/
public class GolfMemInsSkyActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회  
			GolfMemSkyInsDaoProc procSky = (GolfMemSkyInsDaoProc)context.getProc("GolfMemSkyInsDaoProc");
			...
			dataSet.setString("CODE_NO", "SKY"); //제휴업체코드
...
//////////////////////////////////////////////////////////////////
			...
			debug("===================openerType업그레이드 회원 : " + openerType);       	

			returnUrlTrue = "/app/golfloung/index.jsp";
        	returnUrlFalse =  "/app/golfloung/index.jsp";
        	script = "parent.location.href='/app/golfloung/index.jsp'";
        	scriptFalse = "";
			debug("===================일반 회원 : script" + script);
			...
			if (addResult == 2) {
	        	...
	        	// DB저장 실패시 승인취소 전문	        	
				debug("====================GolfMemInsSkyActn =============DB저장 실패시 승인취소 전문 1 ");
	        	...
	        	// DB저장 실패시 승인취소 전문 
				debug("====================GolfMemInsSkyActn =============DB저장 실패시 승인취소 전문 2 ");
	        	if(!GolfUtil.empty(payEtt.getUseNo())){
	        		payCancelResult = payProc.executePayAuthCancel(context, payEtt);			// 취소전문 호출
	        	}
