...
*   클래스명  : GolfAdmEvntBcJoinMutiDelActn
*   작성자    : (주)만세커뮤니케이션 김태완
*   내용      : 관리자 BC GOLF 이벤트 신청관리 당첨취소 처리
*   적용범위  : golf
*   작성일자  : 2009-05-27
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항
...
import com.bccard.golf.dbtao.proc.admin.event.GolfAdmEvntBcJoinMutiDelDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntBcJoinMutiDelActn extends GolfActn{
	
	public static final String TITLE = "관리자 BC GOLF 이벤트 신청관리 당첨취소 처리";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmEvntBcJoinMutiDelDaoProc proc = (GolfAdmEvntBcJoinMutiDelDaoProc)context.getProc("GolfAdmEvntBcJoinMutiDelDaoProc");
			...
			if (evntBcDelResult == recv_no.length) {
				...
				request.setAttribute("resultMsg", "BC GOLF 이벤트 당첨취소가 정상적으로 처리 되지 않았습니다.");
			}
