...
import com.bccard.golf.dbtao.proc.admin.event.GolfAdmEvntBcWinInsDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntBcWinRegActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmEvntBcWinInsDaoProc proc = (GolfAdmEvntBcWinInsDaoProc)context.getProc("GolfAdmEvntBcWinInsDaoProc");
	        ...
	        if (addResult == 1) {
				...
				request.setAttribute("resultMsg", "BC GOLF 이벤트 당첨자 등록이 정상적으로 처리 되었습니다.");      	
	        } else {
				request.setAttribute("returnUrl", "admEvntBcWinRegForm.do");
				request.setAttribute("resultMsg", "BC GOLF 이벤트 당첨자 등록이 정상적으로 처리 되지 않았습니다.\\n\\n반복적으로 등록되지 않을 경우 관리자에 문의하십시오.");		        		
	        }
