...
*   클래스명  : GolfAdmEvntBkTimeMutiChgActn
*   작성자    : (주)만세커뮤니케이션 김태완
...
import com.bccard.golf.dbtao.proc.admin.event.GolfAdmEvntBkTimeMutiUpdDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntBkTimeMutiChgActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// Request 값 저장
			String[] time_seq_no = parser.getParameterValues("cidx", ""); 		// 일련번호
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmEvntBkTimeMutiUpdDaoProc proc = (GolfAdmEvntBkTimeMutiUpdDaoProc)context.getProc("GolfAdmEvntBkTimeMutiUpdDaoProc");
			...
			if (evntBcDelResult == (time_seq_no.length*2)) {
				...
				request.setAttribute("resultMsg", "프리미엄 부킹 이벤트 등록이 정상적으로 처리 되지 않았습니다.");
			}
