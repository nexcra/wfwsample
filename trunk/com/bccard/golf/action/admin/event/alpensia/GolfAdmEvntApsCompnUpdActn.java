...
*   클래스명  : GolfAdmEvntApsCompnUpdActn
*   작성자    : (주)미디어포스 임은혜
...
import com.bccard.golf.dbtao.proc.admin.event.alpensia.GolfAdmEvntApsUpdDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntApsCompnUpdActn extends GolfActn{

	public static final String TITLE = "관리자 > 이벤트 > 알펜시아 > 수정 처리";
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// Proc 파일 정의
			GolfAdmEvntApsUpdDaoProc proc = (GolfAdmEvntApsUpdDaoProc)context.getProc("GolfAdmEvntApsUpdDaoProc");
