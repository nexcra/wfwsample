...
*   클래스명  : GolfAdmEvntApsListXlsActn
*   작성자    : (주)미디어포스 임은혜
*   내용      : 관리자 > 이벤트 > 알펜시아 > 엑셀
*   적용범위  : Golf
*   작성일자  : 2010-06-24
...
import com.bccard.golf.dbtao.proc.admin.event.alpensia.GolfAdmEvntApsListXlsDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntApsListXlsActn extends GolfActn{
	
	public static final String TITLE = "관리자 > 이벤트 > 알펜시아 > 엑셀";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회 
			GolfAdmEvntApsListXlsDaoProc proc = (GolfAdmEvntApsListXlsDaoProc)context.getProc("GolfAdmEvntApsListXlsDaoProc");
