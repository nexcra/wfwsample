...
*   클래스명  : GolfAdmEvntBkWinChgFormActn
*   작성자    : (주)만세커뮤니케이션 김태완
*   내용      : 관리자 BC GOLF 이벤트 당첨자 수정 폼
*   적용범위  : golf
*   작성일자  : 2009-05-27
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항
...
import com.bccard.golf.dbtao.proc.admin.event.GolfAdmEvntBcWinUpdFormDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntBcWinChgFormActn extends GolfActn{
	
	public static final String TITLE = "관리자 BC GOLF 이벤트 당첨자 수정 폼";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmEvntBcWinUpdFormDaoProc proc = (GolfAdmEvntBcWinUpdFormDaoProc)context.getProc("GolfAdmEvntBcWinUpdFormDaoProc");
