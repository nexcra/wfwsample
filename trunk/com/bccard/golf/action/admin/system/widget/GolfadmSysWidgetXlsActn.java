...
* @version	1.0
******************************************************************************/
public class GolfadmSysWidgetXlsActn extends GolfActn{
	
	public static final String TITLE = "관리자 > 시스템 > 위젯 엑셀";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfadmSysWidgetXlsDaoProc proc = (GolfadmSysWidgetXlsDaoProc)context.getProc("GolfadmSysWidgetXlsDaoProc");
