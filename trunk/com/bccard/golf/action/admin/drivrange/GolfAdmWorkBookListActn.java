...
import com.bccard.golf.dbtao.proc.admin.drivrange.GolfAdmWorkBookListDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmWorkBookListActn extends GolfActn{
	
	public static final String TITLE = "관리자 연습장 리스트";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmWorkBookListDaoProc proc = (GolfAdmWorkBookListDaoProc)context.getProc("GolfAdmWorkBookListDaoProc");
			DbTaoResult workbookListResult = (DbTaoResult) proc.execute(context, request, dataSet);

			paramMap.put("resultSize", String.valueOf(workbookListResult.size()));
			
			request.setAttribute("workbookListResult", workbookListResult);
