...
*   클래스명  : GolfAdmRangeDialyListActn
*   작성자    : (주)만세커뮤니케이션 엄지환
...
import com.bccard.golf.dbtao.proc.admin.drivrange.GolfAdmRangeDialyListDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmRangeDialyListActn extends GolfActn{
	
	public static final String TITLE = "관리자 드림 골프레인지 일정 리스트";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmRangeDialyListDaoProc proc = (GolfAdmRangeDialyListDaoProc)context.getProc("GolfAdmRangeDialyListDaoProc");
			
			DbTaoResult rangedialyListResult = (DbTaoResult) proc.execute(context, request, dataSet);
			
			paramMap.put("resultSize", String.valueOf(rangedialyListResult.size()));
			
			request.setAttribute("rangedialyListResult", rangedialyListResult);
