...
* @version	1.0
******************************************************************************/
public class GolfAdmRangeSkyExcelActn extends GolfActn{
	
	public static final String TITLE = "관리자 드림 골프레인지 신청(sky72) 엑셀다운로드";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmRangeSkyExcelDaoProc proc = (GolfAdmRangeSkyExcelDaoProc)context.getProc("GolfAdmRangeSkyExcelDaoProc");
