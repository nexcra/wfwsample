...
import com.bccard.golf.dbtao.proc.admin.drivrange.GolfAdmCouponUpdDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmCouponChgActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			long cupn_seq_no	= parser.getLongParameter("p_idx", 0L);// 일련번호
			...
			String orgImg_nm = parser.getParameter("orgImg_nm", "");	// 기존 쿠폰이미지
			...
			*/
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmCouponUpdDaoProc proc = (GolfAdmCouponUpdDaoProc)context.getProc("GolfAdmCouponUpdDaoProc");
	        ...
	        if (editResult == 1) {
				...
				request.setAttribute("resultMsg", "쿠폰 수정이 정상적으로 처리 되었습니다.");      	
	        } else {
	        	//========================== 파일 업로드 Start =============================================================//
				if ( !GolfUtil.isNull(img_nm)) {
				...
				//========================== 파일 업로드 End =============================================================//
				request.setAttribute("returnUrl", "admCouponChgForm.do");
				request.setAttribute("resultMsg", "쿠폰 수정이 정상적으로 처리 되지 않았습니다.\\n\\n반복적으로 수정되지 않을 경우 관리자에 문의하십시오.");		        		
	        }
