...
*   클래스명  : GolfAdmLsnVodReplyListActn
*   작성자    : (주)만세커뮤니케이션 김태완
*   내용      : 관리자 레슨동영상 덧글 리스트
*   적용범위  : Golf
*   작성일자  : 2009-05-22
...
import com.bccard.golf.dbtao.proc.admin.lesson.GolfAdmLsnVodReplyListDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmLsnVodReplyListActn extends GolfActn{
	
	public static final String TITLE = "관리자 레슨동영상 덧글 리스트";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmLsnVodReplyListDaoProc proc = (GolfAdmLsnVodReplyListDaoProc)context.getProc("GolfAdmLsnVodReplyListDaoProc");
			GolfAdmCodeSelDaoProc coodSelProc = (GolfAdmCodeSelDaoProc)context.getProc("GolfAdmCodeSelDaoProc");
			DbTaoResult lsnVodReplyListResult = (DbTaoResult) proc.execute(context, request, dataSet);
			...
			paramMap.put("resultSize", String.valueOf(lsnVodReplyListResult.size()));
			
			request.setAttribute("lsnVodReplyListResult", lsnVodReplyListResult);
