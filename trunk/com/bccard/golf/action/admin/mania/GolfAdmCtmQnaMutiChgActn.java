...
*   클래스명  : GolfAdmCtmQnaChgActn
*   작성자    : (주)만세커뮤니케이션 김인겸
*   내용      : 관리자 고객센터 1:1고객문의 멀티수정 (처리/미처리)
*   적용범위  : golf
*   작성일자  : 2009-06-17
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항
...
import com.bccard.golf.dbtao.proc.admin.mania.GolfAdmCtmQnaMutiUpdDaoProc;
...
* @version 1.0
******************************************************************************/
public class GolfAdmCtmQnaMutiChgActn extends GolfActn{
 ...
 public ActionResponse execute( WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
  ...
  try {
   // 01.세션정보체크
     ...
     // 04.실제 테이블(Proc) 조회
     GolfAdmCtmQnaMutiUpdDaoProc proc = (GolfAdmCtmQnaMutiUpdDaoProc)context.getProc("GolfAdmCtmQnaMutiUpdDaoProc");
   ...
   if (editResult == seq_no.length) {	   
	   request.setAttribute("returnUrl", "admCtmQnaList.do?bbs=0012");
