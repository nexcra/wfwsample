...
import com.bccard.golf.dbtao.proc.admin.mania.GolfAdmManiaMutiUpdDaoProc;
...
* @version 1.0
******************************************************************************/
public class GolfAdmManiaMutiChgActn extends GolfActn{
 ...
 public ActionResponse execute( WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
  ...
  try {
   // 01.세션정보체크
     ...
     // 04.실제 테이블(Proc) 조회
     GolfAdmManiaMutiUpdDaoProc proc = (GolfAdmManiaMutiUpdDaoProc)context.getProc("GolfAdmManiaMutiUpdDaoProc");
