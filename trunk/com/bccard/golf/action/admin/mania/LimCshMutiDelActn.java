...
import com.bccard.golf.dbtao.proc.admin.mania.LimCshMutiDelDaoProc;
...
* @version	1.0
******************************************************************************/
public class LimCshMutiDelActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			LimCshMutiDelDaoProc proc = (LimCshMutiDelDaoProc)context.getProc("LimCshMutiDelDaoProc");
			// 찜 삭제 ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::	
