...
* @version	1.0 
******************************************************************************/
public class GolfadmSkyTimeDelActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfadmSkyTimeDelDaoProc proc = (GolfadmSkyTimeDelDaoProc)context.getProc("admSkyTimeDelDaoProc");
			// 찜 삭제 ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::	
			if (lsn_seq_no != null && lsn_seq_no.length > 0) {
				lessonDelResult = proc.execute(context, dataSet, lsn_seq_no);
			}			

			request.setAttribute("returnUrl", "admPreTimeListActn.do?SORT=0001");	
			// 실패일 경우
