...
*   클래스명  : GolfadmTopGolfTargetConfUpdActn
*   작성자    : (주)미디어포스 권영만
*   내용      : 관리자 부킹대상관리 평가 처리
*   적용범위  : Golf
*   작성일자  : 2010-11-02
...
public class GolfadmTopGolfTargetConfUpdActn extends GolfActn{
	...
	public static final String TITLE = "관리자 부킹대상관리 평가 처리";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			String[] arr_seq_no = parser.getParameterValues("bkngObjNo", ""); 		// 일련번호
