...
*   클래스명  : GolfadmTopGolfTargetPpListActn
*   작성자    : (주)미디어포스 권영만
*   내용      : 관리자 부킹대상관리
*   적용범위  : Golf
*   작성일자  : 2010-11-02
...
* @version	1.0 
******************************************************************************/
public class GolfadmTopGolfTargetPpListActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			//해당 티타임의 평가처리 값 가져오기
			String strPriYn = proc.topGolfPriYn(context, request, dataSet);
			
			debug("## strPriYn : "+strPriYn);
			
			DbTaoResult listResult = (DbTaoResult) proc.topGolfJoinPpList(context, request, dataSet, strPriYn);			
	        ...
	        request.setAttribute("strPriYn", strPriYn);
