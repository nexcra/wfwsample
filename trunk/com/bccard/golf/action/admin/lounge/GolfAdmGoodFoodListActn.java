...
import com.bccard.golf.dbtao.proc.admin.lounge.GolfAdmGoodFoodListDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmGoodFoodListActn extends GolfActn{
	
	public static final String TITLE = "관리자 맛집 리스트";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			String fd_area_cd	= parser.getParameter("s_fd_area_cd", "");		// 지역선택
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmGoodFoodListDaoProc proc = (GolfAdmGoodFoodListDaoProc)context.getProc("GolfAdmGoodFoodListDaoProc");
			...
			// 코드 조회 ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
			DbTaoResult coopCpSel = coopCpSelProc.execute(context, dataSet, "0021", "Y"); //지역코드
