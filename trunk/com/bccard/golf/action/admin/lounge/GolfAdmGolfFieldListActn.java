...
public class GolfAdmGolfFieldListActn extends GolfActn{
	...
	public static final String TITLE = "관리자 골프장 리스트";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			String gf_area_cd	= parser.getParameter("s_gf_area_cd", "");		// 전지역
			String gf_clss_cd	= parser.getParameter("s_gf_clss_cd", "");		// 회원제/퍼블릭
			String gf_hole_cd	= parser.getParameter("s_gf_hole_cd", "");		// 홀수
