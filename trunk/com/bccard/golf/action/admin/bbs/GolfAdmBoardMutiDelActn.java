...
*   클래스명  : GolfAdmBoardMutiDelActn
*   작성자    : (주)만세커뮤니케이션 김태완
*   내용      : 관리자 공통게시판 다중 삭제 처리
*   적용범위  : golf
*   작성일자  : 2009-05-28
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항
...
import com.bccard.golf.dbtao.proc.admin.bbs.GolfAdmBoardMutiDelDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmBoardMutiDelActn extends GolfActn{
	
	public static final String TITLE = "관리자 공통게시판 다중 삭제 처리";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmBoardMutiDelDaoProc proc = (GolfAdmBoardMutiDelDaoProc)context.getProc("GolfAdmBoardMutiDelDaoProc");
