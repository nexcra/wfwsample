...
* @version	1.0 
******************************************************************************/
public class GolfAdmMemPayListActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// Request 값 저장
			long pay_page_no		= parser.getLongParameter("pay_page_no", 1L);			// 페이지번호
			...
			dataSet.setLong("pay_page_no", pay_page_no);
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmMemPayListDaoProc proc = (GolfAdmMemPayListDaoProc)context.getProc("GolfAdmMemPayListDaoProc");
