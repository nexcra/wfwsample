...
import com.bccard.golf.dbtao.proc.club.GolfClubMemOutMutiUpdDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfClubMemOutMutiChgActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfClubMemOutMutiUpdDaoProc proc = (GolfClubMemOutMutiUpdDaoProc)context.getProc("GolfClubMemOutMutiUpdDaoProc");
			...
			if (editResult == club_cdhd_seq_no.length) {
				...
				request.setAttribute("resultMsg", "동호회 회원 강퇴처리가 정상적으로 처리 되지 않았습니다.");
			}
