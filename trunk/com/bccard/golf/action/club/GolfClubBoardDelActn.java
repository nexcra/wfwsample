...
import com.bccard.golf.dbtao.proc.club.GolfClubBoardDelDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfClubBoardDelActn extends GolfActn{
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			if (!id.trim().equals(userId)) {
				...
				request.setAttribute("resultMsg", "본인이 작성한 글만 삭제가 가능합니다."); 			
			} else {			
				...
				// 04.실제 테이블(Proc) 조회
				GolfClubBoardDelDaoProc proc = (GolfClubBoardDelDaoProc)context.getProc("GolfClubBoardDelDaoProc");
