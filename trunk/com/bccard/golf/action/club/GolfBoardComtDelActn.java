...
import com.bccard.golf.dbtao.proc.club.GolfBoardComtDelDaoProc;
import com.bccard.golf.dbtao.proc.club.GolfBoardComtInqDaoProc;
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfBoardComtInqDaoProc comtInqProc = (GolfBoardComtInqDaoProc)context.getProc("GolfClubBoardComtInqDaoProc");
			...
			if (userId.equals(rgs_pe_id)) {
				GolfBoardComtDelDaoProc proc = (GolfBoardComtDelDaoProc)context.getProc("GolfClubBoardComtDelDaoProc");
