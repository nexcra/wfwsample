...
* @version	1.0
******************************************************************************/
public class GolfClubJoinImgActn extends GolfActn{
	
	public static final String TITLE = "동호회 가입 리스트";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 클럽회원 인증
			String clubMemChk = "";
			if (!clubAdmChk.equals("Y")) clubMemChk = clubProc.getClubMemChk(context, dataSet);
