...
* @version	1.0
******************************************************************************/
public class GolfClubChgFormActn extends GolfActn{
	
	public static final String TITLE = "동호회 정보수정 폼";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			paramMap.put("resultSize", String.valueOf(clubMasterResult.size()));			
			request.setAttribute("clubMasterResult", clubMasterResult);
