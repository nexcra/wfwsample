...
import com.bccard.golf.dbtao.proc.mytbox.golf.GolfMtbTlkDelDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfMtbTlkMutiDelActn extends GolfActn{
...
//			 01.세션정보체크
			...
			// 04.실제 테이블(Proc) 조회
			GolfMtbTlkDelDaoProc proc = (GolfMtbTlkDelDaoProc)context.getProc("GolfMtbTlkDelDaoProc");
			// 찜 삭제 ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::	
			if (seq_no != null && seq_no.length > 0) {
				golfmtfieldDelResult = proc.execute(context, dataSet, seq_no);
			}			

			request.setAttribute("returnUrl", "golfMtbTlkList.do");	
			// 실패일 경우
