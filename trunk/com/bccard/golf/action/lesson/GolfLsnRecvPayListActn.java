...
import com.bccard.golf.dbtao.proc.lesson.GolfLsnRecvPayListDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfLsnRecvPayListActn extends GolfActn{
	
	public static final String TITLE = "레슨프로그램 신청 리스트";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfLsnRecvPayListDaoProc proc = (GolfLsnRecvPayListDaoProc)context.getProc("GolfLsnRecvPayListDaoProc");
