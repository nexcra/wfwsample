...
* @version	1.0
******************************************************************************/
public class GolfEvntBkRecvInsDaoProc extends AbstractProc {
	 ...
	 * @param N/A
	 ***************************************************************** */
	public GolfEvntBkRecvInsDaoProc() {}
    ...
    ************************************************************************ */
	private String getInsertQuery(){
		...
		sql.append("\t  HP_DDD_NO, HP_TEL_HNO, HP_TEL_SNO, REG_ATON	\n");
		sql.append("\t ) VALUES (	\n");	
		sql.append("\t  ?,?,?,'N',?,	\n");
		sql.append("\t 	NULL,NULL,NULL,TO_CHAR(SYSDATE,'YYYYMMDD')||TO_CHAR(SYSDATE,'HH24MISS') \n");	
		sql.append("\t \n)");	
        return sql.toString();
    }
