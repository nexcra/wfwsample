...
*   클래스명  : GolfAdmTopGolfRoundAfterViewProc
*   작성자    : shin cheong gwi
*   내용      : 관리자 > 라운딩후기 상세보기
*   적용범위  : golfloung
*   작성일자  : 2010-11-22
...
public class GolfAdmTopGolfRoundAfterViewProc extends AbstractObject {

	private static GolfAdmTopGolfRoundAfterViewProc instance = null;
	static{
		synchronized(GolfAdmTopGolfRoundAfterViewProc.class){
			if(instance == null){
				instance = new GolfAdmTopGolfRoundAfterViewProc();
			}
		}
	}
	public static GolfAdmTopGolfRoundAfterViewProc getInstance(){
		return instance;
	}
	...
	private StringBuffer getQnaAnswerQuery() throws Exception
	{
		StringBuffer sb = new StringBuffer();
		sb.append("	SELECT	\n");
		sb.append("		BOARD_NO, BOARD_CD, BOARD_SUBJ, BOARD_TEXT, BOARD_DATA, ANS_STG, ANS_LEV,	 	\n");
