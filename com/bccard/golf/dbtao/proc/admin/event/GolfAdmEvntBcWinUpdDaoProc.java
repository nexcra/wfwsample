...
*   클래스명  : GolfAdmEvntBcWinUpdDaoProc
*   작성자    : (주)만세커뮤니케이션 김태완
...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntBcWinUpdDaoProc extends AbstractProc {

	public static final String TITLE = "관리자 BC GOLF 이벤트 당첨자 수정 처리";

	/** *****************************************************************
	 * GolfAdmEvntBcWinUpdDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfAdmEvntBcWinUpdDaoProc() {}
