...
*   클래스명  : GolfAdmEvntBkWinInsDaoProc
*   작성자    : (주)만세커뮤니케이션 김태완
...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntBkWinInsDaoProc extends AbstractProc {

	public static final String TITLE = "관리자 프리미엄 부킹 이벤트 당첨자 등록 처리";

	/** *****************************************************************
	 * GolfAdmEvntBkWinInsDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfAdmEvntBkWinInsDaoProc() {}
	
	/**
	 * 관리자 프리미엄 부킹 이벤트 당첨자 등록 처리
	 * @param conn
	 * @param data
	 * @return
