...
*   클래스명  : GolfAdmEvntBcJoinMutiDelDaoProc
*   작성자    : (주)만세커뮤니케이션 김태완
*   내용      : 관리자 BC GOLF 이벤트 당첨취소 처리
*   적용범위  : golf
*   작성일자  : 2009-05-27
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항
...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntBcJoinMutiDelDaoProc extends AbstractProc {

	public static final String TITLE = "관리자 BC GOLF 이벤트 당첨취소 처리";

	/** *****************************************************************
	 * GolfAdmEvntBcJoinMutiDelDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfAdmEvntBcJoinMutiDelDaoProc() {}
