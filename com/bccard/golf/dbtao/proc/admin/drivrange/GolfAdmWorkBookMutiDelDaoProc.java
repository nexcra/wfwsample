...
*   클래스명  : GolfAdmWorkBookMutiDelDaoProc
*   작성자    : (주)만세커뮤니케이션 엄지환
*   내용      : 관리자 연습장 다중 삭제 처리
*   적용범위  : golf
*   작성일자  : 2009-05-19
...
* @version	1.0
******************************************************************************/
public class GolfAdmWorkBookMutiDelDaoProc extends AbstractProc {

	public static final String TITLE = "관리자 연습장 다중 삭제 처리";

	/** *****************************************************************
	 * GolfAdmWorkBookMutiDelDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfAdmWorkBookMutiDelDaoProc() {}
