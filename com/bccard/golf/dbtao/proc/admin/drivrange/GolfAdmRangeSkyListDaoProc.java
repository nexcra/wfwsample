...
*   클래스명  : GolfAdmRangeSkyListDaoProc
*   작성자    : (주)만세커뮤니케이션 엄지환
 ...
 * @version	1.0
 ******************************************************************************/
public class GolfAdmRangeSkyListDaoProc extends AbstractProc {
	
	/** *****************************************************************
	 * GolfAdmRangeSkyListDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfAdmRangeSkyListDaoProc() {}	
    ...
    * Query를 생성하여 리턴한다.    
    ************************************************************************ */
    private String getSelectQuery(String start_dt, String end_dt, String rsvt_yn, String atd_yn, String search_sel, String search_word, String search_yn, String s_gr){
        StringBuffer sql = new StringBuffer();
		
        sql.append("\n SELECT *	");
		sql.append("\n FROM (SELECT ROWNUM RNUM,	");
		
		sql.append("\n 			GOLF_SVC_RSVT_NO, HG_NM, SUBSTR (JUMIN, 1, 6) ||'-*******' JUMIN,GRADE_NM, HP_DDD_NO, HP_TEL_HNO, HP_TEL_SNO,  	");
		sql.append("\n			RSVT_ABLE_DATE, RSVT_TIME, REG_ATON, RSVT_YN, ATTD_YN, GR_NM, ");
		sql.append("\n			CNCL_ATON,	CDHD_ID	,		");
