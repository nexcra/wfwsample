 ...
 * @version	1.0
 ******************************************************************************/
public class GolfAdmCtmQnaListDaoProc extends AbstractProc {
	
	/** *****************************************************************
	 * GolfAdmBoardListDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfAdmCtmQnaListDaoProc() {}	
    ...
    ************************************************************************ */
    private String getSelectQuery(String search_sel, String search_word, String sch_field_cd, String sch_clss_cd, String sch_sec_cd, String sch_hd_yn, String sreg_sdate, String sreg_edate){
		...
		sql.append("\n 			FROM (SELECT ROWNUM RNUM,	");
		sql.append("\n 				BBRD_SEQ_NO, BBRD_CLSS, GOLF_CLM_CLSS, GOLF_BOKG_FAQ_CLSS, GOLF_VBL_RULE_PREM_CLSS, TITL, CTNT, ID, HG_NM, EMAIL, INQR_NUM, EPS_YN, ANNX_FILE_NM, MVPT_ANNX_FILE_PATH, PROC_YN, DEL_YN, REG_MGR_ID, REG_ATON, BEST_YN, ANW_BLTN_ARTC_YN, REPY_URNK_SEQ_NO, 	");
