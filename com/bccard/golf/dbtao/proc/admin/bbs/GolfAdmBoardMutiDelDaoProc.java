...
*   클래스명  : GolfAdmBoardMutiDelDaoProc
*   작성자    : (주)만세커뮤니케이션 김태완
*   내용      : 관리자 게시판 다중 삭제 처리
*   적용범위  : golf
*   작성일자  : 2009-05-28
...
* @version	1.0
******************************************************************************/
public class GolfAdmBoardMutiDelDaoProc extends AbstractProc {

	public static final String TITLE = "관리자 게시판 다중 삭제 처리";

	/** *****************************************************************
	 * GolfAdmLsnVodMutiDelDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfAdmBoardMutiDelDaoProc() {}
