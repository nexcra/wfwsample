...
package com.bccard.golf.dbtao.proc.booking.normal;
...
public class GolfadmGrUpdFormDaoProc extends AbstractProc {
    ...
    ************************************************************************ */
    private String getSelectQuery(){
		...
		sql.append("\t  TO_CHAR(TO_DATE(REG_ATON,'YYYYMMDD'),'YYYY-MM-DD') REG_DATE, TO_CHAR(TO_DATE(CHNG_ATON,'YYYYMMDD'),'YYYY-MM-DD') CORR_DATE, 	\n");
		...
		sql.append("\t  CAUT_MTTR_CTNT AS GR_NOTI, GREEN_CHRG_INFO AS CH_INFO, MAX_ACPT_PNUM 	\n");
		sql.append("\n FROM");
		sql.append("\n BCDBA.TBGAFFIGREEN");
