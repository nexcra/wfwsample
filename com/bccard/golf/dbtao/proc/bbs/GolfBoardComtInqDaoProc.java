 ...
 * @version	1.0
 ******************************************************************************/
public class GolfBoardComtInqDaoProc extends AbstractProc {
	
	/** *****************************************************************
	 * GolfBoardComtInqDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfBoardComtInqDaoProc() {}	
		...
		try {
			...
			if(rs != null) {
				while(rs.next())  {
					...
					result.addString("REPY_CLSS" 		,rs.getString("REPY_CLSS") );
    ...
    ************************************************************************ */
    private String getSelectQuery(){
		...
		sql.append("\n SELECT");
		sql.append("\n 	REPY_SEQ_NO, BBRD_SEQ_NO, REPY_CLSS, REPY_CTNT, REG_ATON, RGS_PE_ID, CHNG_ATON	");
		sql.append("\n FROM");
		sql.append("\n BCDBA.TBGBBRDREPY	");
		sql.append("\n WHERE REPY_SEQ_NO = ?	");
