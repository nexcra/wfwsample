...
*   클래스명  : GolfSearchMutiPopInqDaoProc
*   작성자    : (주)만세커뮤니케이션 엄지환
*   내용      : 관리자 골프장 다중 검색
*   적용범위  : golf
*   작성일자  : 2009-06-02
 ...
 * @version	1.0
 ******************************************************************************/
public class GolfSearchMutiPopInqDaoProc extends AbstractProc {
	
	/** *****************************************************************
	 * GolfSearchMutiPopInqDaoProc 프로세스 생성자
	 * @param N/A
	 ***************************************************************** */
	public GolfSearchMutiPopInqDaoProc() {}	
	...
	public DbTaoResult execute(WaContext context,  HttpServletRequest request ,TaoDataSet data) throws BaseException {
		...
		try {
			...
			if (!GolfUtil.isNull(gf_nm)){ //골프장명 검색
