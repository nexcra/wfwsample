...
import com.bccard.golf.dbtao.proc.club.GolfBoardComtInsDaoProc;
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfBoardComtInsDaoProc proc = (GolfBoardComtInsDaoProc)context.getProc("GolfClubBoardComtInsDaoProc");
