...
import com.bccard.golf.dbtao.proc.club.GolfClubBoardUpdDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfClubBoardChgActn extends GolfActn{
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			if (!id.trim().equals(userId)) {
				...
				// 04.실제 테이블(Proc) 조회
				GolfClubBoardUpdDaoProc proc = (GolfClubBoardUpdDaoProc) context.getProc("GolfClubBoardUpdDaoProc");
