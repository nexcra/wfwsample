...
import com.bccard.golf.dbtao.proc.club.GolfClubMenuListDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfClubMenuListActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfClubMenuListDaoProc proc = (GolfClubMenuListDaoProc)context.getProc("GolfClubMenuListDaoProc");
			GolfClubMasterDaoProc clubProc = (GolfClubMasterDaoProc)context.getProc("GolfClubMasterDaoProc");
			DbTaoResult menuListResult = (DbTaoResult) proc.execute(context, request, dataSet);
			...
			String clubAdmChk = "N";
			if (userId.equals(clubAdmId) && !clubAdmId.equals("")) clubAdmChk = "Y";
			...
			paramMap.put("resultSize", String.valueOf(menuListResult.size()));			
			request.setAttribute("menuListResult", menuListResult);
