...
import com.bccard.golf.dbtao.proc.club.GolfClubBoardUpdFormDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfClubBoardChgFormActn extends GolfActn{
	
	public static final String TITLE = "공통게시판 수정 폼";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfClubBoardUpdFormDaoProc proc = (GolfClubBoardUpdFormDaoProc)context.getProc("GolfClubBoardUpdFormDaoProc");
