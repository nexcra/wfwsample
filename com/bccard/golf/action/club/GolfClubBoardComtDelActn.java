...
import com.bccard.golf.dbtao.proc.club.GolfClubBoardComtDelDaoProc;
import com.bccard.golf.dbtao.proc.club.GolfClubBoardComtInqDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfClubBoardComtDelActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfClubBoardComtInqDaoProc comtInqProc = (GolfClubBoardComtInqDaoProc)context.getProc("GolfClubBoardComtInqDaoProc");
			...
			if (comtInResult != null && comtInResult.isNext()) {
				...
				if (comtInResult.getObject("RESULT").equals("00")) {
					rgs_pe_id = (String)comtInResult.getString("REG_PE_ID");
				}
			}
			
			int bbsReDelResult = 0;
			if (userId.equals(rgs_pe_id)) {
				GolfClubBoardComtDelDaoProc proc = (GolfClubBoardComtDelDaoProc)context.getProc("GolfClubBoardComtDelDaoProc");
