...
public class GolfMemEvtInsActn extends GolfActn{
	...
	public static final String TITLE = "가입 > 이벤트성 회원 등록";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {			
			...
			if(type.equals("ibkGold")){		// 기업골드 - 2개월짜리 골드 카드 회원 가입 처리
			...
			if(insResult>0){
				...
				String message = "골프라운지 Gold회원가입이 완료되었으며, "+strEdDate+"까지 서비스 이용 가능합니다."; 
