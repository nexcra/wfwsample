...
* @version	1.0
******************************************************************************/
public class GolfBkNotiListActn extends GolfActn {
	
	public static final String TITLE = "공지사항 리스트";
	...
	***************************************************************************************/	
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws BaseException {
		...
		try {
			...
			GolfBkNotiListDaoProc proc = (GolfBkNotiListDaoProc)context.getProc("GolfBkNotiListDaoProc");
