	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			if (fineResult==0){
				...
				request.setAttribute("resultMsg", "해당 일자의 등록이 종료되었습니다..\\n다시 선택해주세요.");      
			}else{
				// 예약처리
				...
				if (addResult != null && addResult.isNext()) {
					...
					if ("00".equals(sRESULT))
					{
						...
						if (!email_id.equals("")) {
							...
							emailTitle = "[Golf Loun.G] SKY72 드림듄스 부킹이 완료되었습니다.";
						...
						if (!hp_TEL.equals("")) {
							...
							//debug("SMS시작>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>..");
							String smsClss = "641";
							String message = "[드림듄스]"+userNm+"님 "+hole+"홀 "+bk_DATE+" "+bk_TIME+" 예약완료 - Golf Loun.G";
