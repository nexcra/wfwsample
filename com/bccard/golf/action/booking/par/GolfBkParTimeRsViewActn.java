...
* @version	1.0 
******************************************************************************/
public class GolfBkParTimeRsViewActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			String rsvt_SQL_NO_ENC			= parser.getParameter("RSVT_SQL_NO_ENC", "");
			debug("========예약결과 가져오는 액션 => rsvt_SQL_NO : " + rsvt_SQL_NO);
			debug("========예약결과 가져오는 액션 => rsvt_SQL_NO_ENC : " + rsvt_SQL_NO_ENC);
			...
			// 04.실제 테이블(Proc)
			GolfBkParTimeRsViewDaoProc proc = (GolfBkParTimeRsViewDaoProc)context.getProc("GolfBkParTimeRsViewDaoProc");
