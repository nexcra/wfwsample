...
*   클래스명  : GolfAdmRangeExcelActn
*   작성자    : (주)만세커뮤니케이션 엄지환
*   내용      : 관리자 드림 골프레인지 신청 엑셀다운로드
*   적용범위  : Golf
*   작성일자  : 2009-07-07
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항
...
import com.bccard.golf.dbtao.proc.admin.drivrange.GolfAdmRangeExcelDaoProc;
...
public class GolfAdmRangeExcelActn extends GolfActn{
	...
	public static final String TITLE = "관리자 드림 골프레인지 신청 엑셀다운로드";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			String sch_gr	= parser.getParameter("SCH_GR_SEQ_NO", "");		// 연습장구분
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmRangeExcelDaoProc proc = (GolfAdmRangeExcelDaoProc)context.getProc("GolfAdmRangeExcelDaoProc");
