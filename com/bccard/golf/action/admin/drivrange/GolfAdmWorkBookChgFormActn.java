...
*   클래스명  : GolfAdmWorkBookChgFormActn
*   작성자    : (주)만세커뮤니케이션 엄지환
*   내용      : 관리자 연습장 수정
*   적용범위  : golf
*   작성일자  : 2009-05-18
...
import com.bccard.golf.dbtao.proc.admin.drivrange.GolfAdmWorkBookUpdFormDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmWorkBookChgFormActn extends GolfActn{
	
	public static final String TITLE = "관리자 연습장 수정 폼";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmWorkBookUpdFormDaoProc proc = (GolfAdmWorkBookUpdFormDaoProc)context.getProc("GolfAdmWorkBookUpdFormDaoProc");
			GolfAdmCodeSelDaoProc coopCpSelProc = (GolfAdmCodeSelDaoProc)context.getProc("GolfAdmCodeSelDaoProc");
			
			// 레슨 프로그램 상세조회 ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
			DbTaoResult workbookInq = proc.execute(context, dataSet);
			DbTaoResult coopCpSel = coopCpSelProc.execute(context, dataSet, "0008", "Y"); //연습장종류코드
			
			// 05. Return 값 세팅			
			//debug("lessonInq.size() ::> " + lessonInq.size());
			
			request.setAttribute("workbookInqResult", workbookInq);	
