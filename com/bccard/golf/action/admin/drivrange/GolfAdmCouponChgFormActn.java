...
import com.bccard.golf.dbtao.proc.admin.drivrange.GolfAdmCouponUpdFormDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmCouponChgFormActn extends GolfActn{
	
	public static final String TITLE = "관리자 쿠폰 수정 폼";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// Request 값 저장
			long cupn_seq_no	= parser.getLongParameter("p_idx", 0);
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmCouponUpdFormDaoProc proc = (GolfAdmCouponUpdFormDaoProc)context.getProc("GolfAdmCouponUpdFormDaoProc");
