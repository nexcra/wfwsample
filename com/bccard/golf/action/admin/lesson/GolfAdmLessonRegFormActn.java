...
* @version	1.0
******************************************************************************/
public class GolfAdmLessonRegFormActn extends GolfActn{
	
	public static final String TITLE = "관리자 레슨프로그램 등록폼";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			String scoop_cp_cd = parser.getParameter("scoop_cp_cd", "0001");	// 레슨타입코드
			if (scoop_cp_cd.equals("")) scoop_cp_cd = "0001";
