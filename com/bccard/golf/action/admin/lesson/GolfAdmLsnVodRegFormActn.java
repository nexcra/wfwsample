...
* @version	1.0
******************************************************************************/
public class GolfAdmLsnVodRegFormActn extends GolfActn{
	
	public static final String TITLE = "관리자 레슨동영상 등록폼";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			DbTaoResult vodClssSel = coodSelProc.execute(context, dataSet, "0007", "Y"); //동영상구분
			DbTaoResult vodLsnClssSel = coodSelProc.execute(context, dataSet, "0013", "Y"); //레슨분류
