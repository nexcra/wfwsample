...
import com.bccard.golf.dbtao.proc.admin.lesson.GolfAdmLessonUpdFormDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmLessonChgFormActn extends GolfActn{
	
	public static final String TITLE = "관리자 레슨프로그램 수정 폼";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmLessonUpdFormDaoProc proc = (GolfAdmLessonUpdFormDaoProc)context.getProc("GolfAdmLessonUpdFormDaoProc");
			...
			DbTaoResult coopCpSel = coopCpSelProc.execute(context, dataSet, "0004", "Y"); //제휴업체
