...
* @version	1.0
******************************************************************************/
public class GolfadmSysWidgetListActn extends GolfActn{
	
	public static final String TITLE = "위젯 리스트";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfadmSysWidgetListDaoProc proc = (GolfadmSysWidgetListDaoProc)context.getProc("GolfadmSysWidgetListDaoProc");
