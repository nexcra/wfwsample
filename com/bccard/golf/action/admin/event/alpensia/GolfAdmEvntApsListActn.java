...
*   클래스명  : GolfAdmEvntApsListActn
*   작성자    : (주)미디어포스 임은혜
*   내용      : 관리자 > 이벤트 > 알펜시아 > 신청 리스트
*   적용범위  : Golf
*   작성일자  : 2010-06-24
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항
...
import com.bccard.golf.dbtao.proc.admin.event.alpensia.GolfAdmEvntApsListDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntApsListActn extends GolfActn{
	
	public static final String TITLE = "관리자 > 이벤트 > 알펜시아 > 신청 리스트";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			String sch_golf_svc_aplc_clss = parser.getParameter("sch_golf_svc_aplc_clss", "");
			...
			dataSet.setString("sch_golf_svc_aplc_clss", sch_golf_svc_aplc_clss);
			
			
			// 04.실제 테이블(Proc) 조회 
			GolfAdmEvntApsListDaoProc proc = (GolfAdmEvntApsListDaoProc)context.getProc("GolfAdmEvntApsListDaoProc");
