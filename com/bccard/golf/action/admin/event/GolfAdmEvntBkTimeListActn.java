...
*   클래스명  : GolfAdmEvntBkTimeListActn
*   작성자    : (주)만세커뮤니케이션 김태완
...
import com.bccard.golf.dbtao.proc.admin.event.GolfAdmEvntBkTimeListDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntBkTimeListActn extends GolfActn{
	
	public static final String TITLE = "관리자 부킹 티타임 리스트";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmEvntBkTimeListDaoProc proc = (GolfAdmEvntBkTimeListDaoProc)context.getProc("GolfAdmEvntBkTimeListDaoProc");
			GolfadmBkTimeRegFormDaoProc proc2 = (GolfadmBkTimeRegFormDaoProc)context.getProc("admBkTimeRegFormDaoProc");
			DbTaoResult evntBkTimeListResult = (DbTaoResult) proc.execute(context, request, dataSet);
			DbTaoResult titimeGreenListResult = (DbTaoResult) proc2.execute(context, request, dataSet);

			paramMap.put("resultSize", String.valueOf(evntBkTimeListResult.size()));
			
			request.setAttribute("evntBkTimeListResult", evntBkTimeListResult);
