...
*   클래스명  : GolfAdmSpecialBookingCnclActn
*   작성자    : 이포넷 은장선
...
* @version	1.0
******************************************************************************/
public class GolfAdmSpecialBookingCnclActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			String cncl_param           = parser.getParameter("cncl_param","");         //변경 예약상태 코드값
			...
			DbTaoResult evntCncl    = proc.setCancel(context, request, dataSet);
