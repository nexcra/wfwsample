...
*   클래스명  : GolfAdmBusDateRegFormActn
*   작성자    : (주)미디어포스 권영만
*   내용      : 관리자 > 이벤트->골프장버스운행이벤트->일정관리 폼
*   적용범위  : Golf
*   작성일자  : 2009-09-25
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항
...
* @version	1.0
******************************************************************************/
public class GolfAdmBusDateRegFormActn extends AbstractAction {

	public static final String TITLE = "관리자 골드장 버스 운행 일정관리 폼";
			...
			BaseException
	{
		...
		try {
			...
			{				
				...
				// 게시판 상세보기 조회		
				result = con.execute("admin.event.golfbus.GolfAdmBusDateDetailInqDaoProc",input);				
