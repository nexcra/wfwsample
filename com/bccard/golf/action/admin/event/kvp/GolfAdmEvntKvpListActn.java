...
import com.bccard.golf.dbtao.proc.admin.event.kvp.GolfAdmEvntKvpListDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntKvpListActn extends GolfActn{
	
	public static final String TITLE = "관리자 > 이벤트 > Kvp이벤트 회원 > 리스트";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회 
			GolfAdmEvntKvpListDaoProc proc = (GolfAdmEvntKvpListDaoProc)context.getProc("GolfAdmEvntKvpListDaoProc");
