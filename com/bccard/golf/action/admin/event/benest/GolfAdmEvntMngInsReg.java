...
* @version	1.0
******************************************************************************/
public class GolfAdmEvntMngInsReg extends GolfActn{
...
////////////////////////////////////////////////////////////////////////////////////////////////
			...
			for(int i = 0 ; i < app_date_arr.length ; i++){
				...
				appResult = proc.excute_app_insert(context,dataSet);
			}
			
	        String returnUrlTrue = "";
	        String returnUrlFalse = "";
	       	returnUrlTrue = "admEvntMngList.do";
	       	debug("appResult"+appResult);
	       	debug("addResult"+addResult);
			if (addResult >0 && appResult >0 ) {
