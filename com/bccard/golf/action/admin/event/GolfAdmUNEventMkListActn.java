...
* @version	1.0
******************************************************************************/
public class GolfAdmUNEventMkListActn extends GolfActn{
	
	public static final String TITLE = "관리자 > 이벤트 > 통합 이벤트 관리";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			String sch_date_st	= parser.getParameter("SCH_DATE_ST", "");           // 시작일
			String sch_date_ed	= parser.getParameter("SCH_DATE_ED", "");              // 종료일
			...
			if(type.equals("excel")){
			  listResult = (DbTaoResult) proc.getNochargeExcelView(context, request, dataSet);
			}else{
				listResult = (DbTaoResult) proc.getNochargeView(context, request, dataSet);
			}
