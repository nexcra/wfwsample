...
import com.bccard.golf.dbtao.proc.admin.mania.GolfAdmClbNtsMutiUpdDaoProc;
...
* @version 1.0
******************************************************************************/
public class GolfAdmClbNtsMutiChgActn extends GolfActn{
 ...
 public ActionResponse execute( WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
  ...
  try {
   // 01.세션정보체크
     ...
     // 04.실제 테이블(Proc) 조회
     GolfAdmClbNtsMutiUpdDaoProc proc = (GolfAdmClbNtsMutiUpdDaoProc)context.getProc("GolfAdmClbNtsMutiUpdDaoProc");
   ...
   if (editResult == seq_no.length) {
	   ...
	   request.setAttribute("returnUrl", "admClbNtsList.do");
