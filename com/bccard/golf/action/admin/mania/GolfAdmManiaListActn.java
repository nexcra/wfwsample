...
import com.bccard.golf.dbtao.proc.admin.mania.GolfAdmManiaListDaoProc;
...
* @version	1.0 
******************************************************************************/
public class GolfAdmManiaListActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			String mem_clss		= parser.getParameter("mem_clss", ""); 		//회원등급
			...
			dataSet.setString("MEM_CLSS", mem_clss);
			
			// 04.실제 테이블(Proc) 조회
			GolfAdmManiaListDaoProc proc = (GolfAdmManiaListDaoProc)context.getProc("GolfAdmManiaListDaoProc");
			...
			DbTaoResult coopCpSel = coopCpSelProc.execute(context, dataSet); //@ 차종 뽑아오기 
...
//			 전체 0건  [ 0/0 page] 형식 가져오기 
			...
			paramMap.put("sckd_code",sckd_code);
			paramMap.put("scnsl_yn",scnsl_yn);
			paramMap.put("sprgs_yn",sprgs_yn);
			paramMap.put("mem_clss",mem_clss);
