...
*   클래스명  : GolfAdmFittingMutiDelActn
*   작성자    : (주)만세커뮤니케이션 김인겸
*   내용      : 관리자 피팅서비스 예약관리 다중삭제처리
*   적용범위  : golf
*   작성일자  : 2009-05-20
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항
...
import com.bccard.golf.dbtao.proc.admin.mania.GolfAdmFittingMutiDelDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmFittingMutiDelActn extends GolfActn{
	
	public static final String TITLE = "관리자 피팅서비스 예약관리 다중삭제처리";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmFittingMutiDelDaoProc proc = (GolfAdmFittingMutiDelDaoProc)context.getProc("GolfAdmFittingMutiDelDaoProc");
			if (seq_no != null && seq_no.length > 0) {
				maniaDelResult = proc.execute(context, dataSet, seq_no);
			}			

			request.setAttribute("returnUrl", "admFittingList.do");	
