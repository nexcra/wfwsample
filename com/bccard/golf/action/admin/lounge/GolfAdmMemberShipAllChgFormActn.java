...
*   클래스명  : GolfAdmMemberShipAllChgFormActn
*   작성자    : (주)만세커뮤니케이션 엄지환
*   내용      : 관리자 회원권 시세 전체수정
*   적용범위  : Golf
*   작성일자  : 2009-05-28
...
public class GolfAdmMemberShipAllChgFormActn extends GolfActn{
	...
	public static final String TITLE = "관리자 회원권 시세 전체수정 폼";
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			*/
			...
			// Request 값 저장
			String fee_year	= parser.getParameter("fee_year", nowYear);		// 년도
			String fee_month	= parser.getParameter("fee_month", GolfUtil.lpad(nowMonth, 2, "0"));	// 월
			String fee_day	= parser.getParameter("fee_day", GolfUtil.lpad(nowDay, 2, "0"));	// 일 
