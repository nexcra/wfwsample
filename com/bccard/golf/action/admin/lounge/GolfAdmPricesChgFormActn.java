...
import com.bccard.golf.dbtao.proc.admin.lounge.GolfAdmPricesUpdFormDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmPricesChgFormActn extends GolfActn{
	
	public static final String TITLE = "관리자 시세 수정 폼";
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			*/
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmPricesUpdFormDaoProc proc = (GolfAdmPricesUpdFormDaoProc)context.getProc("GolfAdmPricesUpdFormDaoProc");
			
			// 프로그램 상세조회 ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
			DbTaoResult pricesInq = proc.execute(context, dataSet);
			...
			request.setAttribute("pricesInqResult", pricesInq);	
