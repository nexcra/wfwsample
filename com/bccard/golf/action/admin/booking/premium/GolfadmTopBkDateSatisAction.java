...
*   클래스명  : GolfadmTopBkDateSatisAction
*   작성자    : (주)미디어포스 이경희
...
import com.bccard.golf.dbtao.proc.admin.booking.premium.GolfadmTopBkDateSatisDaoProc;
...
public class GolfadmTopBkDateSatisAction extends GolfActn{
 

	public static final String TITLE = "TOP년월별부킹신청현황 ";	
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			String schDate = parser.getParameter("parm1");
			...
			dataSet.setString("schDate", schDate);
			dataSet.setString("memberClss", memberClss);			
			dataSet.setString("gubun", gubun);			
			
			GolfadmTopBkDateSatisDaoProc instance = GolfadmTopBkDateSatisDaoProc.getInstance();
			...
			if (!"INIT".equals(mode)) {
				...
				request.setAttribute("BkngDateStatis", listResult);
			...
			if (mode.equals("EXCELDETAIL")) {
				if(gubun.equals("1")) gubun = "회원";
				else if(gubun.equals("2")) gubun = "주중";
				else if(gubun.equals("3")) gubun = "주말";
