...
*   클래스명  : GolfadmTopGolfTargetListActn
*   작성자    : (주)미디어포스 권영만
*   내용      : 관리자 부킹대상관리
*   적용범위  : Golf
*   작성일자  : 2010-11-02
...
* @version	1.0 
******************************************************************************/
public class GolfadmTopGolfTargetListActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			DbTaoResult listResult = (DbTaoResult) proc.topGolfList(context, request, dataSet);
