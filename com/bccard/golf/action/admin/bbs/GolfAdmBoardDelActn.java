...
import com.bccard.golf.dbtao.proc.admin.bbs.GolfAdmBoardDelDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmBoardDelActn extends GolfActn{
	
	public static final String TITLE = "관리자 공통게시판 삭제 처리";
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmBoardDelDaoProc proc = (GolfAdmBoardDelDaoProc)context.getProc("GolfAdmBoardDelDaoProc");
