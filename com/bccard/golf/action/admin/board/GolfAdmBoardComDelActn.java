...
import com.bccard.golf.dbtao.proc.admin.board.GolfAdmBoardComDelDaoProc;
...
* @version	1.0 
******************************************************************************/
public class GolfAdmBoardComDelActn extends GolfActn  {
	...
	***************************************************************************************/	
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws BaseException {
		...
		try {
			...
			// 3. DB 처리 
			GolfAdmBoardComDelDaoProc proc = (GolfAdmBoardComDelDaoProc)context.getProc("GolfAdmBoardComDelDaoProc");
