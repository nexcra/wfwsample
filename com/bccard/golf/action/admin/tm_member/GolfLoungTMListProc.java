 ...
 * @version 2009-05-06
 **************************************************************************** */
public class GolfLoungTMListProc extends AbstractProc {
	public static final String TITLE = "TM회원 조회";
	/** *****************************************************************
	 * GolfLoungTMListProc 프로세스 생성자
	 * @param N/A 
	 ***************************************************************** */
	public GolfLoungTMListProc() { 
	...
	************************************************************************ */
	public TaoResult execute(WaContext context, TaoDataSet data) throws DbTaoException  {
		...
		try {				
			...
			String sch_ez			= data.getString("sch_ez");
			...
			// 이지웰 검색
			if(!GolfUtil.empty(sch_ez)){
				if(sch_ez.equals("Y")){
					sql.append("	AND  A.JOIN_CHNL = 'EZ'	\n");
				}
			}
