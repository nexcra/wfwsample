...
*   클래스명  : GolfAdmTravelListActn
*   작성자    : shin cheong gwi
*   내용      : 관리자 > 어드민관리 > 회원관리 > 여행팀 회원조회
*   적용범위  : Golf
*   작성일자  : 2012-03-07
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항  																		*   
...
* golfloung		
******************************************************************************/
public class GolfAdmTravelListActn extends GolfActn{
	
	public static final String TITLE = "관리자 > 어드민관리 > 회원관리 > 여행팀 회원조회";
...
//			String sch_DATE_ED	= parser.getParameter("SCH_DATE_ED", "");	
			...
			if(sch_TEXT.equals("")){
				dataSet.setLong("page_no", 0);
				dataSet.setLong("record_size", 0);				
			}else{
			...
			dataSet.setString("ACTION_URL", "travel");
