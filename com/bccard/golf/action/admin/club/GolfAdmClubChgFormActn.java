...
import com.bccard.golf.dbtao.proc.admin.club.GolfAdmClubUpdFormDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfAdmClubChgFormActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmClubUpdFormDaoProc proc = (GolfAdmClubUpdFormDaoProc)context.getProc("GolfAdmClubUpdFormDaoProc");
			//리무진별 금액관리 추출
