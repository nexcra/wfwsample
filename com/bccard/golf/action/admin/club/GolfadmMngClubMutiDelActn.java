...
*   클래스명  : GolfAdmMngClubMutiDelActn
*   작성자    : (주)만세커뮤니케이션 김인겸
*   내용      : 관리자 > 전체 동호회 관리 다중삭제처리
*   적용범위  : golf
*   작성일자  : 2009-07-06
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항
...
import com.bccard.golf.dbtao.proc.admin.club.GolfAdmMngClubMutiDelDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfadmMngClubMutiDelActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(	WaContext context,	HttpServletRequest request,	HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			// 04.실제 테이블(Proc) 조회
			GolfAdmMngClubMutiDelDaoProc proc = (GolfAdmMngClubMutiDelDaoProc)context.getProc("GolfAdmMngClubMutiDelDaoProc");
			// 찜 삭제 ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::	
