...
*   클래스명  : GolfAdmClubChgActn
*   작성자    : (주)만세커뮤니케이션 김인겸
*   내용      : 관리자 > 동호회 개설자 멀티수정처리
*   적용범위  : golf
*   작성일자  : 2009-07-06
************************** 수정이력 ****************************************************************
*    일자      버전   작성자   변경사항
...
import com.bccard.golf.dbtao.proc.admin.club.GolfAdmClubMutiUpdDaoProc;
...
* @version 1.0
******************************************************************************/
public class GolfAdmClubMutiChgActn extends GolfActn{
 ...
 public ActionResponse execute( WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
  ...
  try {
   // 01.세션정보체크
     ...
     // 04.실제 테이블(Proc) 조회
     GolfAdmClubMutiUpdDaoProc proc = (GolfAdmClubMutiUpdDaoProc)context.getProc("GolfAdmClubMutiUpdDaoProc");
   ...
   if (editResult == seq_no.length) {
       ...
       request.setAttribute("resultMsg", "개설여부 변경이 정상적으로 처리 되었습니다."); 
