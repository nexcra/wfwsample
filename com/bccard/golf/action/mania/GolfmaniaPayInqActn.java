...
import com.bccard.golf.dbtao.proc.mania.GolfManiaPayInqDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfmaniaPayInqActn extends GolfActn{
	...
	***************************************************************************************/
	...
	public ActionResponse execute(WaContext context, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, BaseException {
		...
		try {
			...
			String ckdj = parser.getParameter("CKDJ", ""); //차종
			...
			// 04.실제 테이블(Proc) 조회
			GolfManiaPayInqDaoProc proc = (GolfManiaPayInqDaoProc)context.getProc("GolfManiaPayInqDaoProc");
