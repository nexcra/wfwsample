...
import com.bccard.golf.dbtao.proc.bbs.GolfMtbTlkListDaoProc;
...
* @version	1.0
******************************************************************************/
public class GolfMtbTlkListActn extends GolfActn{
...
//			 // 01.세션정보체크
			...
			bbs = "0032";
			debug("===================GolfMtbTlkListActn=================bbs : " + bbs);
			String gkey				= parser.getParameter("gkey", "");
			...
			// 04.실제 테이블(Proc) 조회
			GolfMtbTlkListDaoProc proc = (GolfMtbTlkListDaoProc)context.getProc("GolfMtbTlkListDaoProc");
			DbTaoResult bbsListResult = (DbTaoResult) proc.execute(context, request, dataSet);

			debug("++111+++++++++++++ bbsListResult.size() " + bbsListResult.size());
			...
			debug("++222+++++++++++++ bbsListResult.size() " + bbsListResult.size());
